        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT){
                if (resultCode == RESULT_OK ) {
                    ...
                    if (txt.contains("hello") || txt.contains("Hello")){
                        ...
                        speaker.speak("Hello stranger, what's your name?");
                        }
                        else{
                            speaker.speak("Hello " +personName);
                        }
                    }
                    else if (txt.contains("sick") || txt.contains("Sick")){

                        speaker.speak("Getting real sick of all your problems, try calling the Doctor");
                    }
                    ...
                    else if (txt.contains("Eiffel Tower") && txt.contains("tall")){
                        speaker.speak("The Eiffel Tower is 324 meters tall");
                    }
